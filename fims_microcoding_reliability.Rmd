...
## Calculate percent agreement for each participant, total and for each code
...
combos <- combn(unique(indices), 2) #each column is the correct index pair you need
ncol(combos) #number of pair combinations you have, 1:ncol(combos)
combos[,1] #column 1 combos[1,i] and combos[2,i]
```
