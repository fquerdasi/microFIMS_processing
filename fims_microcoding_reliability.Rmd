...
#percent agreement for each code: recode all coders into coder1, coder2 (will work if only 2 coders coded each person), then create the "neutral_coder1", "neutral_coder2" etc. vars, then do the basic kappa and percent agreement calcs
