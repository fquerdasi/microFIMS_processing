...
```
FIXED UP TO HERE FOR NEW ROUND OF BEHAIVOR CERTIFICATION

## Calculate kappas (total only) and base rates for each coder
NOTE: need to drop code-specific kappas NEXT 
```{r}
...
# first remember the new column names
names <- c("active", "neutral", "nonauto", "offtask", "positive", "reject", "uncodable", "withdraw") #ordered alphabetically 
# transpose all but the first column (names)
