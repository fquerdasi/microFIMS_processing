...
for (substring in first_substring) {
  ...
  microfims_validity_merge[i, master_col] <- ifelse(microfims_validity_merge[[low_kappa_flag_col]][i] == "1", microfims_validity_merge[i, final_col], microfims_validity_merge[i, master_col]) 
  }
}
}
...
# replace the 'master' base rates with consesus code base rates...
...
for (substring in first_substring) {
  ...
  validity_microfims[i, master_col] <- ifelse(validity_microfims[["use_certif_codes_flag"]][i] == "1", validity_microfims[i, cons_col], validity_microfims[i, master_col])  
  }
}
}
